...
Здесь будет рассмотрено создание сайта на [GitHub](https://github.com/), а также обратим внимание на некоторые грабли, которые встречаются на пути у каждого,
кто пробовал компилировать Haskell-пакеты и заводить Hakyll под Windows. 
...
т.е. без первых трех байтов, которые любит notepad вставлять, как указатель того, что файл в UTF-8. Можно в [notepad++](http://notepad-plus-plus.org/), например, 
